...
Tout d'abord nous avons voulu observer les différences d'accès à l'éducation selon le genre. Pour ce graphique et le suivant, nous avons opté pour un scatterplot (dans la mesure où nous travaillons sur des )
```{r}
...
```
<br>
On observe, comme on pouvait s'y attendre, que dans une grande majorité de pays, l'accès à l'éducation est plus largement réservé aux Males qu'aux Females. De plus on observe que plus l'accès à l'éducation des Females augmente et plus l'écart rétrécit : les pays au plus grand accès à l'éducation semblent faire moins de différences entre les genres.
<br> 
