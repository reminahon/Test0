...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ce document vise à étudier les innégalités entre hommes et femmes à travers le monde. Les données portes sur 188 pays et comparent les genres selon trois axes : la santé, l'autonomie, et leur présence sur le marché du travail.  
Dans les colonnes du jeu de données on a donc les informations suivantes :

+ les pays
+ l'indice d'innégalité de genre
+ le taux de mortalité maternelle lié à un accouchement
+ le taux de mères adolescentes
+ le taux de femmes au parlement
+ le taux de personnes ayant fait des études secondaires (homme et femme)
+ le taux d'activité professionnel (homme et femme)

L'indice d'innégalité de genre est calculé à partir de tous les autres comme le montre le shéma suivant.
...
# Comparaison des pays en fonction de l'indice d'innégalité



&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Les trois graphes ci-dessous permettent de comparer les pays selon les innégalités entre hommes et femmes.  
  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Le premier graphe, intitulé "top 15 countries" classe et affiche les 15 pays dans lesquels les innégalités sont les plus faibles. On constate que c'est la Slovenie qui est le pays le plus égalitaire suivie par la Suisse et l'Allemagne. La France est en treizième position. 

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Le second graphe est équivalant au premier mais présente les 15 pays qui on les plus forts taux d'innégalités avec en dernières positions le Chad, le Niger et le Yemen.  

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Le dernier graphe présente les innégalités par continent et permet de se rendre compte de l'étendue de celle-ce à travers le monde. En effet l'indice d'innégalité va de la droites verte (la Slovénie), à la droite rouge (le Yemen). On voit également qu'en moyenne les continents de l'hémisphère sud sont moins égalitaires.
